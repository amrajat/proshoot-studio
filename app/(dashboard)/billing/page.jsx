      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{credits?.starter || 0}</div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Team plan credits</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              All credit transactions including purchases, usage, and transfers
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
                          ...
                          <TableCell>
                            {transaction.related_studio_id ? (
                              <Badge variant="outline">
                                {transaction.related_studio_id.substring(0, 8)}
                                ...
                              </Badge>
                            ) : (
                              "N/A"
