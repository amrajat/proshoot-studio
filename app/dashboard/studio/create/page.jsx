...
export default function Replicate() {
  ...
  const steps = [
    ...
    { id: "Step 5", component: "VariableSelector", data: PROFESSIONS },
    { id: "Step 6", component: "VariableSelector", data: CLOTHINGS },
    { id: "Step 7", component: "VariableSelector", data: GROOMING },
    { id: "Step 8", component: "VariableSelector", data: GAZE_DIRECTIONS },
    { id: "Step 9", component: "VariableSelector", data: BACKGROUNDS },
    { id: "Step 10", component: "VariableSelector", data: LIGHTINGS },
    { id: "Step 11", component: "VariableSelector", data: EXPRESSIONS },
    { id: "Step 12", component: "VariableSelector", data: CAMERA_TYPE },
    { id: "Step 13", component: "VariableSelector", data: CAMERA_LENSES },
    { id: "Step 14", component: "VariableSelector", data: APERTURE },
    { id: "Step 15", component: "VariableSelector", data: IMAGE_QUALITY_TYPE },
    {
      id: "Step 16",
      component: "VariableSelector",
      data: STUDIO_NAME_SELECTOR,
    },
    { id: "Step 17", component: "FileUploader" },
  ];
