...
export default function Form() {
  ...
  const ACCEPTED_IMAGE_TYPES = ["jpg", "gif", "png"];
  ...
  //         oldErrors[`${index}`] = `This ${index} image has size issues.`;
  //         return oldErrors;
  //       });
  //   });
  //   if (images.some((image) => image.size > MAX_IMAGE_SIZE)) {
  //     setImageError((prevErrors) => {
  //       return prevErrors.toSpliced(0, 1, true);
  //     });
  //   }
  //   if (images.some((image) => !image.type.startsWith("image/"))) {
  //     setImageError((prevErrors) => {
  //       return prevErrors.toSpliced(1, 1, true);
  //     });
  //   }
            ...
            <div>
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div className="sm:col-span-full">
                  this is the guide line for uploading images for best possible
                  results.
                </div>
                <div className="sm:col-span-full">
