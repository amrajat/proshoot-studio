...
function CookieBanner() {
  ...
  useEffect(() => {
    ...
    // Show the banner if they haven't accepted
          ...
          <div className="flex gap-x-4">
            ...
            <div>
              <button
                ...
                className="p-2 inline-flex items-center gap-x-2 text-sm font-semibold rounded border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
              >
                <span className="sr-only">Accept Cookies</span>
                <HiXMark
                  className="size-4 text-blue-600 hover:text-blue-700"
                  strokeWidth={1.25}
                />
              </button>
            </div>
