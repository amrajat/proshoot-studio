"use client";
import { getCurrentUserProfile } from "@/lib/supabase/actions/server";
import Image from "next/image";
import useSWR from "swr";

function AppHeader() {
  const fetcher = () => getCurrentUserProfile(id);
  const {
    data: { data: [user] = [] } = {},
    error,
    isLoading,
            ...
            >
              ...
              >
                <div className="py-3 px-5 -m-2 bg-gray-100 rounded-t-lg dark:bg-gray-700">
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-gray-300"></p>
                </div>
