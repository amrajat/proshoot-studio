...
export default async function StudioCard({ studio, index }) {
  ...
  return (
    <Card className="group rounded-lg shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col overflow-hidden border border-border/50">
      ...
      <CardContent className="p-4 space-y-3 flex-grow">
        ...
        <div className="text-xs text-muted-foreground space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Badge
              variant={studio.downloaded ? "success" : "secondary"}
              className="text-xs"
            >
