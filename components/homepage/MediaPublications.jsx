  ...
  return (
    <>
        ...
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="sm:w-1/2 xl:w-1/3 mx-auto text-center mb-6 md:mb-12">
            <h2 className="text-xl font-semibold md:text-2xl md:leading-tight text-gray-800 dark:text-gray-200">
              Trusted by Employees of Multinational Enterprises Worldwide
            </h2>
          </div>
          <p className="mt-2 lg:text-lg text-gray-800 dark:text-gray-200 text-center my-6 md:my-12">
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mb-6 md:mb-12">
        ...
        <div className="sm:w-1/2 xl:w-1/3 mx-auto text-center mb-6 md:mb-12">
          <h2 className="text-xl font-semibold md:text-2xl md:leading-tight text-gray-800 dark:text-gray-200">
            Recognized by Media Publications
          </h2>
        </div>
        <p className="mt-2 lg:text-lg text-gray-800 dark:text-gray-200 text-center my-6 md:my-12">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:gap-20 md:grid-cols-3 lg:grid-cols-5 lg:gap-8">
          ...
          <div className="text-center">
            <svg
              className="w-auto h-8 mx-auto text-gray-800"
              width={227}
              height={88}
              viewBox="0 0 180 90"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
              <Image src="/laurel.svg" alt="" width={153} height={51} />
            </div>
          ...
          <div className="text-center">
            ...
            <div className="mt-2 sm:mt-6">
              <p className="text-gray-800">
                The Future of images are AI-Powered
              </p>
            </div>
            {/* Star */}
            <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
          ...
          <div className="text-center">
            ...
            <div className="mt-2 sm:mt-6">
              <p className="text-gray-800">
                A Headshot App That Makes Sense for Businesses
              </p>
            </div>
            {/* Star */}
            <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
          ...
          <div className="text-center">
            ...
            <div className="mt-2 sm:mt-6">
              <p className="text-gray-800">
                A Promising AI Tool for Hassle-Free Headshots
              </p>
            </div>
            {/* Star */}
            <div className="flex-shrink-0 flex justify-center space-x-1 mt-3">
