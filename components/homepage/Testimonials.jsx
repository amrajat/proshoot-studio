        ...
        <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
          ...
          <div className="lg:col-span-4">
            ...
            <blockquote>
              ...
              >
                <g id="形状_4_3_" style={{ enableBackground: "new" }}>
                  <g id="形状_4">
                    <g>
                      <path
                ...
                <g id="形状_4_2_" style={{ enableBackground: "new" }}>
                  <g id="形状_4_1_">
                    <g>
                      <path
              ...
              >
                ...
                captured my essence perfectly. The attention to detail and
                realism makes it a winner in my book.
              </p>
