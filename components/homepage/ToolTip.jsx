...
function ToolTip({ children }) {
  return (
    <div className="hs-tooltip inline-block align-middle before:content-['\00a0']">
      <button
        type="button"
        className="hs-tooltip-toggle size-4 inline-flex justify-center items-center gap-2 rounded bg-gray-50 border border-gray-200 text-blue-600 hover:bg-blue-50 hover:border-blue-200 hover:text-blue-700      "
      >
