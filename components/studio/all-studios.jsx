...
import { fetchStudio } from "@/app/(dashboard)/actions/studio/fetchStudio";
import { toggleFavorite } from "@/app/(dashboard)/actions/studio/toggleFavorite";
 ...
 */
export default function AllStudios({ studioId, currentUserId }) {
