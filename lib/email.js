...
import { env, getBaseUrlFromEnv } from "./env";

if (!env.ZEPTOMAIL_API_URL || !env.ZEPTOMAIL_SENDMAIL_TOKEN) {
  console.warn(
...
const client = new SendMailClient({
  ...
  token: env.ZEPTOMAIL_SENDMAIL_TOKEN,
});

// Branding & defaults
const BRAND_NAME = "Proshoot";
const BRAND_EMAIL = "no-reply@proshoot.co";
const BRAND_URL = getBaseUrlFromEnv();
...
const sendTransactionalEmail = async (to, subject, htmlBody, textBody) => {
