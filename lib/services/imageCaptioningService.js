...
function safeBase64Decode(base64Data) {
  try {
    ...
    // Try an alternative approach if the standard method fails
    try {
      // Use a more robust approach for special characters
      ...
      console.error("Fallback base64 decoding also failed:", fallbackError);
      return null;
    }
  }
}
