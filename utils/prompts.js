export default function generatePrompts(userInputs) {
  ...
  const greeneryBackgrounds = [
    `a photorealistic professional portrait of ohwx, natural and approachable tone, suitable for corporate profiles and LinkedIn. Featuring a poised ${ethnicity} ${gender} in ${
      ...
      gender === "woman"
        ? "a fitted light beige knit top with a structured collar"
    ...
    `a vibrant and professional headshot of ohwx, colorful yet polished tone, perfect for creative business profiles. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a serene professional portrait of ohwx, natural and polished tone, ideal for business branding. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a warm and professional portrait of ohwx, approachable and natural tone, suitable for business and personal branding. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a calm and professional headshot of ohwx, natural yet polished tone, perfect for eco-conscious or outdoor industry profiles. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a serene professional portrait of ohwx, calm yet confident tone, suitable for eco-conscious or creative professionals. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a captivating, photorealistic image of ohwx, vibrant and nostalgic tone, perfect for creative business branding. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
  ...
  const officeBackgrounds = [
    `a sleek and professional portrait of ohwx, corporate and polished tone, ideal for LinkedIn and executive profiles. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a refined professional portrait of ohwx, corporate and neutral tone, perfect for business branding. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a polished and approachable professional portrait of ohwx, business-friendly tone, ideal for corporate profiles. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a sleek professional portrait of ohwx, global and business-oriented tone, perfect for high-level corporate branding. Featuring a poised ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a warm and professional portrait of ohwx, intellectual and polished tone, ideal for consulting and academic profiles. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a cinematic-style studio portrait of ohwx, vibrant yet professional tone, suitable for LinkedIn and business profiles. Featuring a professional ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a vibrant professional portrait of ohwx, neutral yet approachable tone, ideal for business branding and LinkedIn profiles. Featuring a photorealistic capture of a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
    ...
    `a sleek and professional portrait of ohwx, corporate and approachable tone, perfect for LinkedIn profiles. Featuring a confident ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
  ...
  const solidBackgroundTemplate = (bgColor) =>
    `a photorealistic studio portrait of ohwx, neutral and professional tone, suitable for various business uses, most popular on Shutterstock, featuring a professional ${ethnicity} ${gender} in ${
      gender === "man" ? "his" : gender === "woman" ? "her" : "their"
    } ${age}, with ${eyeColor} eyes, ${hairStyle}${
      glasses ? ", wearing glasses" : ""
      ...
      gender === "woman"
        ? [
            "a white fitted midi dress with sleeves",
            "a fitted dark forest green crew-neck sweater",
            "a black ribbed turtleneck",
            "a fitted crisp white long-sleeve button-up shirt",
